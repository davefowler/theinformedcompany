...
As of writing this, most comprehensive books on analytics architecture that we’ve found are over a decade old, most of them pre-cloud. Because there really isn’t a modern equivalent to Kimball’s seminal The Data Warehouse Toolkit, today’s data teams still have to reinvent for themselves the principles of building a data stack, and too often, they do this without guidance. We wanted to solve this problem. We wanted to create a best-practices type guide for bootstrapping and nurturing a technologically-current data warehouse.
